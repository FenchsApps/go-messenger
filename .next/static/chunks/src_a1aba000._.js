...
"[project]/src/app/data:7441c9 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$7441c9__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:7441c9 [app-client] (ecmascript) <text/javascript>");
...
function ChatView({ initialMessages, currentUser, chatPartner, isMobile, onBack }) {
    ...
    const handleSendMessage = async (text)=>{
        ...
        startTransition(async ()=>{
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$7441c9__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getFilteredMessage"])(text);
            if (result.error) {
                toast({
                    title: "AI Error",
...
_s(ChatView, "oKaNoxCrGniOyAS0oxF8AgBZLkg=", false, function() {
    return [
...
_s(Messenger, "+ssyVw0PC056BVVy3Kyw3LVC1kI=", false, function() {
    return [
...
//# sourceMappingURL=src_a1aba000._.js.map