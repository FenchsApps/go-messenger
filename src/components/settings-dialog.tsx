...
import { Settings, Moon, Sun, Monitor, CaseSensitive, User as UserIcon, Loader2, Palette, UserCircle } from 'lucide-react';
        ...
        <Tabs defaultValue="profile" className="w-full">
            ...
            <TabsContent value="profile" className="py-4">
                 <div className="space-y-4">
                    ...
                    <Button onClick={handleSaveProfile} disabled={isProfilePending} className="w-full">
